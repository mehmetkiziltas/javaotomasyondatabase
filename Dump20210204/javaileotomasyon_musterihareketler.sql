...
--
-- Table structure for table `musterihareketler`
--

DROP TABLE IF EXISTS `musterihareketler`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `musterihareketler` (
  `HAREKETID` int NOT NULL AUTO_INCREMENT,
  `URUNID` int DEFAULT NULL,
  `ADET` int DEFAULT NULL,
  `PERSONEL` int DEFAULT NULL,
  `MUSTERI` int DEFAULT NULL,
