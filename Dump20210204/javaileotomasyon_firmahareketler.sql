...
--
-- Table structure for table `firmahareketler`
--

DROP TABLE IF EXISTS `firmahareketler`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `firmahareketler` (
  `HAREKETID` int NOT NULL AUTO_INCREMENT,
  `URUNID` int DEFAULT NULL,
  `ADET` varchar(45) COLLATE utf8_turkish_ci DEFAULT NULL,
  `PERSONEL` varchar(45) COLLATE utf8_turkish_ci DEFAULT NULL,
  `FIRMA` varchar(45) COLLATE utf8_turkish_ci DEFAULT NULL,
