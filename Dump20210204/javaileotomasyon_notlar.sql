...
CREATE TABLE `notlar` (
  ...
  `BASLIK` varchar(45) COLLATE utf8_turkish_ci DEFAULT NULL,
  `DETAY` varchar(450) COLLATE utf8_turkish_ci DEFAULT NULL,
  `OLUSTURAN` varchar(45) COLLATE utf8_turkish_ci DEFAULT NULL,
  `HITAP` varchar(45) COLLATE utf8_turkish_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
